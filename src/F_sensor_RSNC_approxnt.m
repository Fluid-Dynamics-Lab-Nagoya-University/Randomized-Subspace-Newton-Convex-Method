function [zhat L ztilde Utilde data] = F_sensor_RSNC_approxnt(A, k, MAXITER, l)
% function [zhat L ztilde Utilde data] = sens_sel_randomized_full_approxnt(A, k, MAXITER, l)
% function [zhat L ztilde Utilde NT_TOL_cal iter] = F_sensor_RSN_approxnt(A, k, MAXITER, l)
% Solves the problem
